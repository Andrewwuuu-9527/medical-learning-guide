...
(function(global) {
    ...
    const MLGUtils = {
        ...
        theme: {
             ...
             */
            init() {
                const savedTheme = MLGUtils.storage.getItem('theme', 'light');
            ...
            applyTheme(theme) {
                ...
                MLGUtils.storage.setItem('theme', selectedTheme);
                
                // 发布主题变更事件
                MLGUtils.events.emit('themeChange', { theme: selectedTheme });
            },
        ...
        init() {
            ...
            try {
                ...
                console.error('❌ MLGUtils 初始化失败:', error);
                return false;
            }
        }
    };
    ...
    // 暴露到全局作用域
    global.MLGUtils = MLGUtils;
    
    console.log('✅ MLGUtils 加载完成');
